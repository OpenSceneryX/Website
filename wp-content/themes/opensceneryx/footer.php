	...
	<footer id="colophon" role="contentinfo">
			...
			<div id="site-generator">
				...
				<div style='float:left; margin-right:1em; margin-top: 2.2em; margin-left: 1em;'>
					<a rel='license' class='nounderline' href='http://creativecommons.org/licenses/by-nc-nd/3.0/' onclick='window.open(this.href);return false;'><img alt='Creative Commons License' class='icon' src='/doc/cc_logo.png' /></a>
				</div>
				...
				<?php /*<a href="<?php echo esc_url( __( 'http://wordpress.org/', 'twentyeleven' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'twentyeleven' ); ?>" rel="generator"><?php printf( __( 'Proudly powered by %s', 'twentyeleven' ), 'WordPress' ); ?></a> */ ?>
			</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
