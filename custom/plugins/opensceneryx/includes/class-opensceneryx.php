...
class OpenSceneryX {
    ...
    function osxScripts()
    {
        ...
        wp_enqueue_script('three.js', '//unpkg.com/three@0.129/build/three.min.js', array(), false, true);
        wp_enqueue_script('3ddsloader', '//unpkg.com/three@0.129/examples/js/loaders/DDSLoader.js', array('three.js'), false, true);
        wp_enqueue_script('3orbitcontrols', '//unpkg.com/three@0.129/examples/js/controls/OrbitControls.js', array('three.js'), false, true);
