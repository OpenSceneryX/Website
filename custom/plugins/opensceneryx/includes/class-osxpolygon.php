...
class OSXPolygon extends OSXLibraryItem {
    ...
    protected function getTypeSpecificHTML() {
        ...
        if ($this->textureScaleH !== null && $this->textureScaleV !== null) {
            $result .= "<li><span class='fieldTitle'>Texture Scale</span> <dfn class='tooltip'>ⓘ<span>By default, one iteration of this polygon's texture covers " . $this->textureScaleH . "m horizontally and " . $this->textureScaleV . "m vertically, but this can be overridden when placing the polygon. For more information, <a href='https://developer.x-plane.com/article/draped-polygon-polfac-file-format-specification/' target='_blank'>see the official documentation</a>.</span></dfn>: <span class='fieldValue'>h: " . $this->textureScaleH . "m, v: " . $this->textureScaleV . "m</span></li>\n";
        }
