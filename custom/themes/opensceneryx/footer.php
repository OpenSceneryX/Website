	...
	<footer id="colophon" role="contentinfo">
			...
			<div id="site-generator">
				...
				<div style='margin-top: 2.2em; margin-left: 1em'>
					<a rel='external' class='nounderline' href='https://twitter.com/opensceneryx' onclick='window.open(this.href);return false;'><img alt='Follow OpenSceneryX on Twitter' class='icon' src='/extras/twitter_follow.png' height="30" /></a>&nbsp;
					<a rel='external' class='nounderline' href='https://www.facebook.com/OpenSceneryX/' onclick='window.open(this.href);return false;'><img alt='Follow OpenSceneryX on Facebook' class='icon' src='/extras/facebook_follow.svg' height="30" /></a>
				</div>
				<div style='clear:both;'>&nbsp;</div>
			</div>
	</footer><!-- #colophon -->
